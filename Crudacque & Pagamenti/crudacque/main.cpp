    ...
    while (inMenu) {
        ...
        cout <<R"(
                   ...
                   | (_ |/ _ \ V /| _|  | |   | || (_) | .` || |    \__ \  _  |   /  _  | |__   _
                    \___/_/ \_\_/ |___| |_|   |_| \___/|_|\_|___|   |___/ (_) |_|_\ (_) |____| (_)
            ...
            case 1: {
                ...
                if (!fTrimestre.is_open()) {
                    ...
                    if (posAttuale < 1) {
                        ...
                        system("cls");
                        gotoXY(37, 10);
                        cout << "Quale utente si vuole modificare? (da 1 a " << posAttuale << ")";
                        gotoXY(36, 11);
                        cout << "──────────────────────────────────────────────";
                        gotoXY(55, 12);
                        cout << "-> ";
            ...
            case 2: {
                ...
                if (!fTrimestre.is_open()) {
                    ...
                    if (posAttuale < 1) {
                        ...
                        system("cls");
                        gotoXY(20, 11);
                        cout << "Non ci sono utenti nel sistema! Aggiungi altri utenti prima di poterli cancellare";
                        Sleep(4000);
                        system("cls");
                    } else {
...
void cancellaUtente(int &posAttuale, int &contanti, fstream &fTrimestre) {
    ...
    while (continuaCancellazione) {
        ...
        while (true) {
            hideCursor();
            lunghezza = 37  + strlen(tab[n - 1].utente);
            gotoXY(34, 10);
            cout << "Sei sicuro di voler cancellare l'utente: " << tab[n - 1].utente;
            gotoXY(33, 11);
            for(int j = 0; j < lunghezza + 6; j++) {
                cout << "─";
            }
...
void visuallizzaUtenti(int posAttuale, fstream &fTrimestre) {
    ...
    for (int i = 0; i < posAttuale; i++) {
        if(!uscita.attivo) {
            ...
            gotoXY(x, y);
            cout << "Utente numero " << i+1;
            y++;
            gotoXY(x, y);
            y++;
            gotoXY(x, y);
            cout << "Nome Utente: "<<uscita.utente;
            y++;
            gotoXY(x, y);
            cout << "Codice fiscale: "<<uscita.codiceFiscale;
            y++;
            gotoXY(x, y);
            cout << "Indirizzo: "<<uscita.indirizzo;
            y++;
            gotoXY(x, y);
            cout << "Trimestre attuale: "<<uscita.trimestreAttuale << " mq";
            y++;
            gotoXY(x, y);
            cout << "Trimestre precedente: "<<uscita.trimestrePrecedente << " mq";
            y++;
            gotoXY(x, y);
            cout << "Bollette non pagate: "<<uscita.bolletteNonPagate << " EURO";
            y++;
            gotoXY(x-1, y);
            cout << "────────────────────────────";
            y++;
